...
let movies : [Movie] = [
    ...
    Movie(title:"TheGodFather", image:UIImage(named: "TheGodFather")!, releasedYear: "1972", movieRating: "9.1", boxOffice: "100M"),
    Movie(title:"MemoriesofMurder", image:UIImage(named: "MemoriesofMurder")!, releasedYear: "2009", movieRating: "8.6", boxOffice: "200M")
